...
//        String date = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));​
        ...
        //where screen shot will be stored
        //System.getProperty("user.dir") returns the path of the project as a string
        String target = System.getProperty("user.dir") + "/test-output/Screenshots/" + name + date + ".png";

        //if it doesn't take screen shot in anyway, remove date and time part
        //forsome reason it doesnt work with date
